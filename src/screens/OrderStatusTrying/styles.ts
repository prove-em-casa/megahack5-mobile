...
export const OrderStatusTryingTextContainer = styled.View`
  margin-top: 40px;
...
export const SelectLabel = styled(InformationLabel)`
  align-self: flex-start;
  margin-top: 15px;
  margin-left: 35px;
`;
...
export const ConcludeButton = styled(DefaultButton)`
  margin-top: 30px;
  width: 134px;
  height: 30px;
`;
